...
public class Launcher {
    public static void main(String[] args) {
        ...
        Role testUserRole = new Role(RoleType.TEACHER);
        Role savedUserRole = roleRepo.save(testUserRole);
        UserRepository userRepo = new UserRepository();
        User testUser = new User("Armas", "Nevolainen", "armas@gmail.com", "password",savedUserRole);
...
//        Role testRole = new Role(RoleType.TEACHER);
        Role savedRole = roleRepo.save(savedUserRole);
